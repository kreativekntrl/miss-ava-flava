...
const Footer = () => {
    return(
        <div>   
            ...
            <SocialMediaIconsReact className="social-icon" borderColor="rgba(0,0,0,0.25)" borderWidth="3" borderStyle="solid" icon="twitter" iconColor="rgba(255,255,255,1)" backgroundColor="rgba(117,123,127,0.89)" iconSize="5" roundness="50%" url="https://twitter.com/missavaflavaa?s=11&t=ahTs3pTTGo7sgqgtx3GomA" size="35" />
